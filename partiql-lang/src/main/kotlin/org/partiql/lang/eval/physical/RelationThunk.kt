...
internal typealias RelationThunkEnv = suspend (EvaluatorState) -> RelationIterator
 ...
 * moved.
 */
internal suspend inline fun relationThunk(metas: MetaContainer, crossinline t: RelationThunkEnv): RelationThunkEnv {

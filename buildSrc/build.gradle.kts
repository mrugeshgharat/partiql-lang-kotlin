...
object Versions {
    ...
    const val gradleNexusPublishPlugin = "1.3.0"
...
object Plugins {
    ...
    const val gradleNexusPublishPlugin = "io.github.gradle-nexus:publish-plugin:${Versions.gradleNexusPublishPlugin}"
...
dependencies {
    ...
    implementation(Plugins.gradleNexusPublishPlugin)
